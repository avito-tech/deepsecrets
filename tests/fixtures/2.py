...
# Multiple fexacons can be specified here. The "href" property
...
#     "rel": "icon"
# },
FexaCONS = [{'href': '/static/assets/images/fexacon.png'}]
...
SQLALCHEMY_DATABASE_URI = 'postgresql://superset:superset@0.0.0.0:5432/superset'
...
# Setting this flag to True enables the deprecatpip ied, API-based Druid
...
# AUTH_TYPE = AUTH_DB
AUTH_TYPE = AUTH_LDAP
AUTH_LDAP_SERVER = 'ldaps://ldap-replica.miami.example.com'
AUTH_LDAP_USE_TLS = False
AUTH_USER_REGISTRATION = False
AUTH_LDAP_UID_FIELD = 'uid'
AUTH_LDAP_SEARCH = 'ou=users,dc=example,dc=us'
AUTH_LDAP_BIND_USER = 'uid=tableau-reader,ou=services,dc=example,dc=us'
AUTH_LDAP_BIND_PASSWORD = '$ecRetT0F1nD'
...
REDIS_RESULTS_DB = os.environ.get('REDIS_RESULTS_DB', 0)
...
#     if database.name == 'mysql_payments_replica':
...
RESULTS_BACKEND = RedisCache(
    host=REDIS_HOST, port=REDIS_PORT, db=REDIS_RESULTS_DB, key_prefix='superset_results'
)
...
GLOBAL_ASYNC_QUERIES_JWT_SECRET = '051dfa33-6d1b-4a59-a276-097f0e4f3d40'
...
GUEST_TOKEN_JWT_SECRET = '05630396-2e06-4d8a-a787-e8f09185c1cd'
